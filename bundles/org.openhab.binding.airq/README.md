...
| WIFIbssid                 | String   | Network BSSID                            |
...
| air-Q-Hardware-Version    | String   | Hardware version |
...
| air-Q-Software-Version    | String   | Firmware version                           |
...
| Industry                  | Switch   | Industry version                                                    |
...
| SensorInfo                | String   | Information about the sensors                                       |
...
String airQ_WIFIssid                "Network SSID"                          {channel="airq:airq:1:WIFIssid"}
String airQ_WIFIpass                "Wifi Password"                         {channel="airq:airq:1:WIFIpass"}
String airQ_WIFIbssid               "Network BSSID"                         {channel="airq:airq:1:WIFIbssid"}
